...
class Solution{
  public int[] plusOne(int[] digits){
   ...
   //if even after end of for loop , our fuction didn't return anything then it simply means that all the digits are 9 and hence we need to return new array with one extra space having 1 at 0th index and the rest index as zero.
